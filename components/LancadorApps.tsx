  ...
  return (
    <div className={`flex flex-col h-full ${classesdoTema.bg} transition-colors duration-300`}>
      ...
      <div className={`flex-1 overflow-y-auto ${classesdoTema.texto}`}>
        <div className="w-full max-w-3xl mx-auto p-4 sm:p-6 space-y-5 sm:space-y-6">
          {/* Título */}
          ...
          {curiosidadeDiaria && (
            <button
              ...
              className={`
                w-full max-w-2xl mx-auto block bg-gradient-to-br from-blue-500/20 to-blue-500/10 
          ...
          {/* Dica */}
          <div className={`p-3 sm:p-4 rounded-xl border-l-4 transition-colors duration-300 ${classesdoTema.dica} max-w-2xl mx-auto`}>
      ...
      <footer className={`flex-shrink-0 border-t ${classesdoTema.borda} p-3 sm:p-4 text-center text-xs sm:text-sm transition-colors duration-300 ${classesdoTema.rodape}`}>
        <p className="max-w-xl mx-auto">Aperte o botão abaixo para voltar ao início a qualquer momento</p>
      </footer>
    </div>
  )
}
